  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'product',
          component: () =>
            import('../views/小米透明电视.vue')
        },
        {
          path: '/product/17',
          name: 'product',
          component: () =>
            import('../views/Redmi G 游戏本.vue')
        },
        {
          path: '/product/29',
          name: 'product',
          component: () =>
            import('../views/米家扫拖机器人1T.vue')
        },

        {
          path: '/product/32',
          name: 'product',
          component: () => import('./../views/product32.vue')
        },
        {
          path: '/product/41',
          name: 'product',
          component: () => import('./../views/product41.vue')
        },
        {
          path: '/product/48',
          name: 'product',
          component: () => import('./../views/product48.vue')
        },

        {
          path: '/product/57',
          name: 'product',
          component: () => import('../views/product57.vue')
        },

        {
          path: '/product/64',
          name: 'product',
          component: () => import('./../views/product64.vue')
        },
        {
          path: '/product/:id',
          name: 'product',
